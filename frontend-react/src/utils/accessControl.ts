...
export const MODULE_MENU_PERMISSIONS: Record<string, string[]> = {
  ...
  reports: ['reports.view', 'reports.students.view', 'reports.students.export', 'reports.manage'],
  contracts: ['contracts.view', 'contracts.create', 'contracts.generate', 'contracts.send', 'contracts.approve', 'contracts.reject', 'contracts.renew', 'contracts.download', 'contracts.templates.manage', 'contracts.manage', 'documents.view', 'documents.manage'],
  document_workflow: ['documents.view', 'documents.create', 'documents.edit', 'documents.delete', 'documents.generate', 'documents.send', 'documents.approve', 'documents.reject', 'documents.renew', 'documents.download', 'documents.templates.manage', 'documents.types.view', 'documents.types.manage', 'documents.settings.manage', 'documents.manage', 'contracts.view', 'contracts.manage'],
}
