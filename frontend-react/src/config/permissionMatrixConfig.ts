...
export const permissionMatrixSections: MatrixSection[] = [
  ...
  },
  {
    ...
    rows: [
      row('ts_report', 'Time Sheet Report', ['view_timesheet_reports', 'timesheets.report', 'timesheets.view_timesheet_reports'], ['export_timesheet_reports'], ['timesheets.manage', 'reject_timesheets']),
      row('ts_overtime', 'Overtime Report', ['view_overtime_reports', 'view_timesheet_reports'], ['export_timesheet_reports'], ['timesheets.manage', 'reject_timesheets']),
      row('ts_manage_all', 'Manage All', ['view_all_timesheets', 'timesheets.manage', 'timesheets.review'], ['approve_timesheets', 'reject_timesheets', 'timesheets.approve_timesheets', 'timesheets.reject_timesheets'], ['reject_timesheets', 'timesheets.reject_timesheets', 'timesheets.manage']),
