        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-blue-100">
              Manage every school on the platform — licenses, plans, expiry dates, admins, and students. Click a school name to create accounts, or Switch Institution to work inside that school.
            </p>
          </div>
          <button
            type="button"
