...
export const ApplicationForm: React.FC = () => {
  ...
  const handleStep2Submit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!selectedAcademicYear || !selectedProgramme) {
      setLocalError(t('selectProgrammeOption'));
      return;
    }
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <div className="mb-8">
        <div className="mb-4">
          <UploadProgressBar progress={Math.round((step / 3) * 100)} label="Application progress" />
        </div>
            ...
            <div>
              ...
              {subdivisionOptions.length > 0 ? (
                <SearchableSelect
                  ...
                  placeholder={`Search ${subdivision.label.toLowerCase()}...`}
                />
              ) : (
                <input
                  type="text"
