...
Route::middleware(['auth:api', 'platform_super_admin'])->prefix('super-admin')->group(function () {
    ...
    Route::post('users', 'Api\SuperAdmin\PlatformUserController@store');
...
Route::middleware(['auth:api', 'resolve_institution'])->group(function () {
    ...
    Route::prefix('people')->group(function () {
        ...
        Route::post('customers/bulk-delete', 'Api\People\CustomerController@bulkDestroy');
        ...
        Route::post('billers/bulk-delete', 'Api\People\BillerController@bulkDestroy');
        ...
        Route::post('suppliers/bulk-delete', 'Api\People\SupplierController@bulkDestroy');
        ...
        Route::post('teachers/bulk-delete', 'Api\People\TeacherController@bulkDestroy');
        ...
        Route::post('staff/bulk-delete', 'Api\People\StaffController@bulkDestroy');
